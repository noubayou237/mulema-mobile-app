...
export function getGhomalaVirtualData(themeId) {
  const themeMap = {
    "ghomala_pronoms": {
      title: "Les pronoms personnels en ghomala",
      items: [
        { sourceText: "Moi", targetText: "Gɔ", audioKey: "moi" },
        { sourceText: "Tu", targetText: "O / wǒ", audioKey: "toi" },
        { sourceText: "Il ou Elle", targetText: "Ayə́ / â", audioKey: "lui" },
        { sourceText: "Nous", targetText: "Pə́kyə́ / pé", audioKey: "nous" },
        { sourceText: "Vous", targetText: "Pə́", audioKey: "vous" },
        { sourceText: "Ils ou Elles", targetText: "Pɔ́", audioKey: "eux" },
      ]
    },
    "ghomala_chiffres": {
...
export function getGhomalaThemeItems(themeId) {
  const themeMap = {
    ...
    "ghomala_etre": {
      title: "Verbe Être",
      items: [
        { sourceText: "Je suis", targetText: "Gɔ â", audioKey: "ga_b_je_suis" },
        { sourceText: "Tu es", targetText: "O â", audioKey: "o_b_tu_es" },
        { sourceText: "Il/Elle est", targetText: "A â", audioKey: "e_b_il_ou_elle_est" },
        { sourceText: "Nous sommes", targetText: "Pəkyə́ / pə́ â", audioKey: "py_b_nus_sommes" },
        { sourceText: "Vous êtes", targetText: "Pə́ pu â", audioKey: "po_b_vous_etes" },
        { sourceText: "Ils/Elles sont", targetText: "Pɔ́ â", audioKey: "wap_b_ils_ou_elles_sont" },
      ],
    },
    "ghomala_avoir": {
      title: "Verbe Avoir",
      items: [
        { sourceText: "J'ai", targetText: "Gɔ ghǎ pə", audioKey: "ga_g_j_ai" },
        { sourceText: "Tu as", targetText: "O ghǎ pə", audioKey: "o_g_tu_as" },
        { sourceText: "Il/Elle a", targetText: "À ghǎ pə", audioKey: "e_g_il_ou_elle_as" },
        { sourceText: "Nous avons", targetText: "Pékyə́ / Pé ghǎ pə", audioKey: "py_g_nous_avons" },
        { sourceText: "Vous avez", targetText: "Pə́/pú ghǎ pə", audioKey: "po_g_vous_avez" },
        { sourceText: "Ils/Elles ont", targetText: "Pɔ̀  ghǎ pə", audioKey: "wap_g" },
      ],
    },
    "ghomala_manger": {
      title: "Le Verbe Manger",
      items: [
        { sourceText: "Je Mange", targetText: "Gɔ zə̂ pə́", audioKey: "ga_mpfa_je_mange" },
        { sourceText: "Tu manges", targetText: "O zə̂ pə", audioKey: "o_mpfa_tu_mange" },
        { sourceText: "Il/Elle Mange", targetText: "A zə̂ pə", audioKey: "e_mpfa_il_ou_elle_mange" },
        { sourceText: "Nous mangeons", targetText: "Pəkyə / Pə zə̂ pə", audioKey: "py_mpfa_nous_mangeons" },
        { sourceText: "Vous mangez", targetText: "Pə pu zə̂ pə", audioKey: "po_mpfa_vous_mangez" },
        { sourceText: "Ils/Elles mangent", targetText: "Pɔ́ zə̂ pə", audioKey: "wap_mpfa_ils_ou_elles_magent" },
      ],
    },
    "ghomala_marcher": {
      ...
      items: [
        { sourceText: "Moi", targetText: "Gɔ", audioKey: "moi" },
        { sourceText: "Tu", targetText: "O / wǒ", audioKey: "toi" },
        { sourceText: "Il/Elle", targetText: "Ayə́ / â", audioKey: "lui" },
        { sourceText: "Nous", targetText: "Pə́kyə́ / pé", audioKey: "nous" },
        { sourceText: "Vous", targetText: "Pə́", audioKey: "vous" },
        { sourceText: "Ils/Elles", targetText: "Pɔ́", audioKey: "eux" },
      ],
    },
    "ghomala_chiffres": {
