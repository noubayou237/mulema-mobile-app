...
const progressionData = [
  // REMARQUE : Les chemins des images doivent être corrects dans votre arborescence
  {
    label: "Famille",
    value: 24,
    avatar: require("../../assets/images/avatar-famille.png")
  },
  {
    label: "Cuisine",
    value: 18,
    avatar: require("../../assets/images/avatar-cuisine.webp")
  },
  {
    label: "Vêtements",
    value: 14,
    avatar: require("../../assets/images/avatar-vetement.png")
  }
];
    ...
    <View style={styles.card}>
      <View style={styles.goalContent}>
        ...
        <Text style={styles.goalText}>
          {t ? t("stats.weeklyGoal") : "des objectifs atteints cette semaine"}
        </Text>
      </View>
    </View>
  );
...
const DetailedProgressCard = ({ data, t }) => {
  ...
  const points = data.map((item, index) => {
    ...
    const normalizedY =
      1 - (item.value - minValue) / (maxValue - minValue + 1e-9);
    ...
    <SafeAreaView style={styles.flexOne} edges={["top"]}>
      ...
      >
        ...
        <TouchableOpacity style={styles.returnButton} onPress={goToCommunity}>
          <Text style={styles.returnButtonText}>{t("common.back")}</Text>
        </TouchableOpacity>
