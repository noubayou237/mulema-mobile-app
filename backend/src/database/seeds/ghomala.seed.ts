...
const THEMES = [
  // ── 00 — NIVEAU 1 : FONDATIONS (Jours & Verbes) ─────────────────
  {
    ...
    words: [
      ...
      // --- Leçon 7 : Les pronoms personnels en ghomala ---
      { order: 39, category: 'Les pronoms personnels', word_fr: 'Moi (je)', word_local: 'Gɔ', hint: 'G', audio_key: 'moi' },
      { order: 40, category: 'Les pronoms personnels', word_fr: 'Toi (tu)', word_local: 'O / wǒ', hint: 'O', audio_key: 'toi' },
      { order: 41, category: 'Les pronoms personnels', word_fr: 'Il ou Elle', word_local: 'Ayə́ / â', hint: 'A', audio_key: 'lui' },
      { order: 42, category: 'Les pronoms personnels', word_fr: 'Nous', word_local: 'Pə́kyə́ / pé', hint: 'P', audio_key: 'nous' },
      { order: 43, category: 'Les pronoms personnels', word_fr: 'Vous', word_local: 'Pə́', hint: 'P', audio_key: 'vous' },
      { order: 44, category: 'Les pronoms personnels', word_fr: 'Ils ou Elles', word_local: 'Pɔ́', hint: 'P', audio_key: 'eux' },

      // --- Leçon 8 : Les chiffres 0-9 en ghomala ---
      { order: 45, category: 'Les chiffres 0-9 en ghomala', word_fr: 'Zéro', word_local: 'ywə̂ně', hint: 'y', audio_key: 'le_chiffre_0_en_ngohmala' },
      { order: 46, category: 'Les chiffres 0-9 en ghomala', word_fr: 'Un', word_local: 'yaə̂mu\'', hint: 'y', audio_key: 'le_chiffre_1_en_ngohmala' },
      { order: 47, category: 'Les chiffres 0-9 en ghomala', word_fr: 'Deux', word_local: 'yaə́pʉə́ə́', hint: 'y', audio_key: 'le_chiffre_2_en_ngohmala' },
      { order: 48, category: 'Les chiffres 0-9 en ghomala', word_fr: 'Trois', word_local: 'yaə́tá', hint: 'y', audio_key: 'le_chiffre_3_en_ngohmala' },
      { order: 49, category: 'Les chiffres 0-9 en ghomala', word_fr: 'Quatre', word_local: 'yápfʉə̀', hint: 'y', audio_key: 'le_chiffre_4_en_ngohmala' },
      { order: 50, category: 'Les chiffres 0-9 en ghomala', word_fr: 'Cinq', word_local: 'yaə́tɔ̂', hint: 'y', audio_key: 'le_chiffre_5_en_ngohmala' },
      { order: 51, category: 'Les chiffres 0-9 en ghomala', word_fr: 'Six', word_local: 'ntɔkɔ́', hint: 'n', audio_key: 'le_chiffre_6_en_ngohmala' },
      { order: 52, category: 'Les chiffres 0-9 en ghomala', word_fr: 'Sept', word_local: 'sɔmbuə́ə́', hint: 's', audio_key: 'le_chiffre_7_en_ngohmala' },
      { order: 53, category: 'Les chiffres 0-9 en ghomala', word_fr: 'Huit', word_local: 'hɔ̌m', hint: 'h', audio_key: 'le_chiffre_8_en_ngohmala' },
      { order: 54, category: 'Les chiffres 0-9 en ghomala', word_fr: 'Neuf', word_local: 'vʉ\'ʉ́', hint: 'v', audio_key: 'le_chiffre_9_en_ngohmala' },
    ],
  },
