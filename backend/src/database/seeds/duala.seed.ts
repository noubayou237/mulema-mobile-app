...
export async function main() {
  ...
  if (!lang) {
    ...
    console.log(`✅ PatrimonialLanguage "Duala" créée (${lang.id})\n`);
  } else {
    console.log(`ℹ️  PatrimonialLanguage "Duala" existante (${lang.id})\n`);
  }
  ...
  for (const t of THEMES) {
    ...
    console.log(`     ✅ 3 exercices\n`);
  }

  console.log('══════════════════════════════════════════════');
  console.log(`✅ Seed terminé ! ${THEMES.length} thèmes · ${THEMES.reduce((a, t) => a + t.words.length, 0)} mots`);
  console.log('══════════════════════════════════════════════');
}
