...
export default function BottomNav({ activeKey = "exercices" }) {
  ...
  const items = [
    { key: "home", label: t("nav.home"), iconName: "home-outline" }, // Utiliser MDI ou Ionicons pour le Home
    { key: "lessons", label: t("nav.lessons"), iconName: "book-open-outline" }, // Utiliser MDI pour Lessons
    { key: "exercices", label: t("nav.exercises"), iconName: "medal-outline" }, // Utiliser MDI pour Exercises/Trophy
    {
      key: "community",
      label: t("nav.community"),
      iconName: "account-group-outline"
    } // Utiliser MDI pour Community/People
  ];
